...
import logoAnton from "./photos/anton1.png";
import logoReturnofidea from "./photos/returnofidea.jpg";
import logoJiffy from "./photos/jiffy.png";

const clientLogos = [
  { name: "Anton Paar", img: logoAnton },
  { name: "Hindustan", img: logoHindustan },
  { name: "Finfinity", img: logoFinfinity },
  { name: "Dronacharya", img: logoDronacharya },
  { name: "Policy", img: logoPolicy },
  { name: "Return of Idea", img: logoReturnofidea },
  { name: "Jiffy", img: logoJiffy },
];
  ...
  return (
    <>
      ...
      <section className="relative bg-[#050507] text-white overflow-hidden">
        ...
        {/* HERO */}
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 pt-28 sm:pt-36 lg:pt-40 pb-14 text-center relative z-10">
          {/* Top Badge */}
        ...
        <div className="border-t border-white/10">
          <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-6 grid grid-cols-1 md:grid-cols-3 gap-6 text-center">
            <div>
      ...
      <section className="bg-[#050507] text-white px-4 sm:px-6 lg:px-8 py-14 sm:py-20 lg:py-24">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="mb-10 lg:mb-16">
            ...
            <h3 className="text-gray-400 text-base sm:text-lg mb-8">
              B2B teams trust VitalHawks to fill their pipeline with the right
              people.
            </h3>
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-7 gap-4">
              {clientLogos.map((client) => (
                <div
                  key={client.name}
                  className="flex items-center justify-center h-20 rounded-xl px-4 py-3
          ...
          {/* Divider */}
          <div className="border-t border-white/10 mb-10 lg:mb-16"></div>
          ...
          <section className="bg-[#050507] text-white px-6 ">
            <div className="max-w-7xl mx-auto">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                {/* Card 1 */}
                <div className="rounded-2xl border border-white/10 bg-gradient-to-b from-white/5 to-white/[0.02] p-6 lg:p-8 backdrop-blur-xl">
