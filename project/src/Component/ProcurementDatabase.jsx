...
const faqs = [
  {
    q: "Which procurement roles can you reach?",
    a: "Procurement heads and CPOs, purchase managers, supply chain and sourcing heads, materials and stores heads, vendor management leaders, and category managers. You define the roles; we build to them.",
  },
  {
    q: "Can you filter procurement heads by industry and company size?",
    a: "Yes. Every list is custom-built around your ICP — industry, company size, and geography. We can deliver purchase heads at pharma plants in Gujarat, or hospital procurement heads across a region, depending on your target.",
  },
  {
    q: "Do you provide direct mobile numbers?",
    a: "Yes. Direct mobile numbers plus verified work emails on every contact. Procurement heads sit behind plant switchboards and shared purchase inboxes — a direct mobile is the only way through.",
  },
  {
...
export default function ProcurementDatabase() {
  const [open, setOpen] = useState(null);

  useSeo({
    title: "Procurement Head Database India | Purchase Contacts | VitalHawks",
    description:
      "Verified procurement contact lists — direct mobile numbers and work emails of procurement and purchase heads at Indian companies. 95% accuracy, fast delivery.",
    ...
    <div className="relative bg-[#050507] text-white overflow-hidden">
      ...
      <section className="relative z-10 max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 pt-28 sm:pt-36 lg:pt-40 pb-14 text-center">
        ...
        <p className="mt-6 text-gray-400 max-w-2xl mx-auto text-lg leading-relaxed">
          Direct mobile numbers and verified work emails of procurement heads, purchase managers, and supply chain leaders — across manufacturing, healthcare, infrastructure, and enterprise. Verified by hand, in your inbox by the next morning.
        </p>
      ...
      <section className="relative z-10 border-t border-white/10">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-14">
          <h2 className="text-3xl sm:text-4xl font-semibold mb-3">
            Why procurement contacts decide your deal
          </h2>
          <p className="text-gray-400 max-w-2xl mb-10">
            Procurement is where B2B purchases live or die — and it's the function generic databases map worst.
          </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="rounded-2xl border border-white/10 bg-white/5 p-6">
              ...
              <p className="text-gray-400 text-sm leading-relaxed">
                No matter who champions your product internally, procurement signs the order. Not being on their radar means not being in the deal.
              </p>
            </div>
            <div className="rounded-2xl border border-white/10 bg-white/5 p-6">
              <h3 className="font-semibold mb-2 text-purple-300">
                Buried in the org chart
              </h3>
              <p className="text-gray-400 text-sm leading-relaxed">
                Purchase heads rarely have a public profile or a listed number. They sit behind plant switchboards and generic purchase inboxes.
              </p>
            </div>
            <div className="rounded-2xl border border-white/10 bg-white/5 p-6">
              <h3 className="font-semibold mb-2 text-purple-300">
                Category-specific owners
              </h3>
              <p className="text-gray-400 text-sm leading-relaxed">
                Large companies split procurement by category — raw materials, capex, IT, services. Reaching the wrong one wastes the entire pitch.
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="rounded-2xl border border-white/10 bg-gradient-to-b from-white/5 to-white/[0.02] p-6 lg:p-8">
              <h3 className="font-semibold mb-4 text-purple-300">
                Procurement roles we cover
              </h3>
              <ul className="text-gray-400 text-sm leading-relaxed space-y-2">
                <li>→ Procurement heads and CPOs</li>
                <li>→ Purchase managers and purchase heads</li>
                <li>→ Supply chain and sourcing heads</li>
                <li>→ Materials and stores heads</li>
                <li>→ Vendor management leaders</li>
                <li>→ Category and commodity managers</li>
              </ul>
            </div>
            ...
            <div className="rounded-2xl border border-white/10 bg-gradient-to-b from-white/5 to-white/[0.02] p-6 lg:p-8">
              ...
              <ul className="text-gray-400 text-sm leading-relaxed space-y-2">
                ...
                <li>→ Pharma and chemicals</li>
                <li>→ Hospitals and healthcare groups</li>
                <li>→ Real estate, EPC and infrastructure</li>
                <li>→ IT and enterprise technology</li>
                <li>→ Retail, FMCG and logistics</li>
              </ul>
            </div>
          </div>
        </div>
      ...
      <section className="relative z-10 border-t border-white/10">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-14">
          ...
          <p className="text-gray-400 max-w-3xl mb-8 leading-relaxed">
            ...
            targeted list of purchase heads or sustained delivery across an entire vertical, the process is the same.
          </p>
        ...
        <div className="relative rounded-2xl border border-white/10 bg-gradient-to-br from-[#0b0b12] to-[#0a0a10] p-6 md:p-8 lg:p-10 flex flex-col md:flex-row items-start md:items-center justify-between gap-6 overflow-hidden">
          ...
          <div className="relative z-10 max-w-xl">
            <h2 className="text-2xl md:text-4xl font-light text-gray-200 leading-tight">
              Need procurement heads in your pipeline?
            </h2>
