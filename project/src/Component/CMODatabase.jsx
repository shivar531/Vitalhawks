...
const faqs = [
  {
    q: "Which marketing roles can you reach?",
    a: "CMOs, marketing directors, VPs of Marketing, marketing and brand heads, growth heads, demand-gen and performance-marketing leads, and founders who own the marketing call. You define the seniority; we build to it.",
  },
  {
    q: "Can you filter CMOs by industry and company size?",
    a: "Yes. Every list is custom-built around your ICP — industry, company size, revenue band, and geography. We can deliver CMOs at 200+ employee SaaS firms in Bengaluru, or marketing heads at D2C brands in Mumbai, or whatever your target is.",
  },
  {
    q: "Do you provide direct mobile numbers?",
    a: "Yes. Direct mobile numbers plus verified work emails on every contact. With marketing leaders drowning in vendor email, a mobile number is often the only channel that gets a real response.",
  },
  {
...
export default function CMODatabase() {
  const [open, setOpen] = useState(null);

  useSeo({
    title: "CMO Database India | Verified CMO & Marketing Head Contacts | VitalHawks",
    description:
      "Verified CMO contact lists — direct mobile numbers and work emails of CMOs and marketing heads at Indian companies. 95% accuracy, next-morning delivery.",
    path: "/cmo-database",
    faqs,
  });
    ...
    <div className="relative bg-[#050507] text-white overflow-hidden">
      ...
      <section className="relative z-10 max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 pt-28 sm:pt-36 lg:pt-40 pb-14 text-center">
        ...
        <p className="mt-6 text-gray-400 max-w-2xl mx-auto text-lg leading-relaxed">
          Direct mobile numbers and verified work emails of CMOs, marketing directors, and marketing heads across Indian companies — filtered by industry, company size, and geography. Verified by hand, in your inbox by the next morning.
        </p>
      ...
      <section className="relative z-10 border-t border-white/10">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-14">
          <h2 className="text-3xl sm:text-4xl font-semibold mb-3">
            Why marketing leaders are hard to reach directly
          </h2>
          <p className="text-gray-400 max-w-2xl mb-10">
            Every martech vendor and agency is chasing the same inbox — so generic outreach disappears without a trace.
          </p>

          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="rounded-2xl border border-white/10 bg-white/5 p-6">
              <h3 className="font-semibold mb-2 text-purple-300">
                Buried under vendor pitches
              </h3>
              <p className="text-gray-400 text-sm leading-relaxed">
                A CMO's inbox is a graveyard of cold tool and agency pitches. A generic email joins the pile; a direct line is what actually cuts through.
              </p>
            </div>
            <div className="rounded-2xl border border-white/10 bg-white/5 p-6">
              <h3 className="font-semibold mb-2 text-purple-300">
              ...
              <p className="text-gray-400 text-sm leading-relaxed">
                CMO, Marketing Head, VP Marketing, Growth Head, Brand Head — generic databases conflate them and you pitch the wrong seniority.
              </p>
            </div>
            <div className="rounded-2xl border border-white/10 bg-white/5 p-6">
              <h3 className="font-semibold mb-2 text-purple-300">
                A fast-moving function
              </h3>
              <p className="text-gray-400 text-sm leading-relaxed">
                Marketing leadership reorganises and rotates constantly. A list built months ago emails people who have already moved on — which is why every contact of ours is checked before delivery.
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="rounded-2xl border border-white/10 bg-gradient-to-b from-white/5 to-white/[0.02] p-6 lg:p-8">
              ...
              <ul className="text-gray-400 text-sm leading-relaxed space-y-2">
                <li>→ CMOs and Chief Marketing Officers</li>
                <li>→ Marketing directors and VPs of Marketing</li>
                <li>→ Marketing, brand and growth heads</li>
                <li>→ Digital and performance marketing leads</li>
                <li>→ Demand generation and content heads</li>
                <li>→ Founders who own the marketing call</li>
              </ul>
            </div>
            ...
            <div className="rounded-2xl border border-white/10 bg-gradient-to-b from-white/5 to-white/[0.02] p-6 lg:p-8">
              ...
              <ul className="text-gray-400 text-sm leading-relaxed space-y-2">
                ...
                <li>→ D2C, e-commerce and consumer brands</li>
                <li>→ BFSI, fintech and financial services</li>
                <li>→ Healthcare and pharma</li>
                <li>→ Real estate and education</li>
      ...
      <section className="relative z-10 border-t border-white/10">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-14">
          ...
          <p className="text-gray-400 max-w-3xl mb-8 leading-relaxed">
            ...
            targeted list of CMOs or sustained delivery across an entire industry, the process is the same.
          </p>
