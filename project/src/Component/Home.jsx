          ...
          <section className="bg-[#050507] text-white px-6 ">
            <div className="max-w-7xl mx-auto">
              ...
              <div className="mt-4 flex justify-center">
                <a href="https://calendly.com/shiva-vitalhawks/15min" target="_blank" rel="noopener noreferrer" className="px-6 py-3 rounded-xl border border-purple-500/30 bg-purple-500/10 text-purple-300 hover:bg-purple-500/20 transition">These results could be yours — book a call</a>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:p-6">
            ...
            <div className="rounded-2xl border border-white/10 bg-gradient-to-b from-white/5 to-white/[0.02] p-4 sm:p-6 backdrop-blur-xl">
              ...
              <a href="https://calendly.com/shiva-vitalhawks/15min" target="_blank" rel="noopener noreferrer" className="text-sm px-4 py-2 rounded-lg border border-white/10 hover:bg-white/5 transition text-gray-300">Get similar results — book a call</a>
            </div>
            ...
            <div className="rounded-2xl border border-white/10 bg-gradient-to-b from-white/5 to-white/[0.02] p-4 sm:p-6 backdrop-blur-xl">
              ...
              <a href="https://calendly.com/shiva-vitalhawks/15min" target="_blank" rel="noopener noreferrer" className="text-sm px-4 py-2 rounded-lg border border-white/10 hover:bg-white/5 transition text-gray-300">Start your success story — book a call</a>
            </div>
          </div>
        </div>
      </section>
