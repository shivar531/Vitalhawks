...
const faqs = [
  {
    q: "Which pharma roles can you reach?",
    a: "R&D and formulation heads, quality heads, QA/QC managers, regulatory affairs heads, plant and production heads, procurement heads, and founders or managing directors. We build to the roles you name — including technical decision-makers who rarely sit in generic databases.",
  },
  {
    q: "Which pharma sub-sectors do you cover?",
    a: "Formulations and generics, APIs and intermediates, contract manufacturers (CDMO/CMO), nutraceuticals, Ayurvedic and herbal manufacturing, plus pharma packaging and machinery suppliers — including companies in clusters like Baddi, Sikkim, Ahmedabad, Hyderabad, and Vizag.",
  },
  {
    q: "Do you provide direct mobile numbers?",
    a: "Yes. Direct mobile numbers plus verified work emails on every contact. Pharma R&D and quality leaders are reachable on mobile, not through a plant switchboard or a generic info@ inbox.",
  },
  {
    ...
    <div className="relative bg-[#050507] text-white overflow-hidden">
      ...
      <section className="relative z-10 max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 pt-28 sm:pt-36 lg:pt-40 pb-14 text-center">
        ...
        <p className="mt-6 text-gray-400 max-w-2xl mx-auto text-lg leading-relaxed">
          Direct mobile numbers and verified work emails of R&amp;D heads,
          QA and QC leaders, regulatory affairs heads, and plant leaders at
          Indian pharma companies. Verified by hand, in your inbox by the next
          morning.
        </p>
      ...
      <section className="relative z-10 border-t border-white/10">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-14">
          <h2 className="text-3xl sm:text-4xl font-semibold mb-3">
            Why pharma decision-makers are hard to reach
          </h2>
          <p className="text-gray-400 max-w-2xl mb-10">
            Pharma buying decisions run through technical gatekeepers — and
            those are exactly the people missing from off-the-shelf databases.
          </p>

          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="rounded-2xl border border-white/10 bg-white/5 p-6">
              <h3 className="font-semibold mb-2 text-purple-300">
                Technical leaders aren't online
              </h3>
              <p className="text-gray-400 text-sm leading-relaxed">
                R&amp;D and QA leaders spend their day in a lab or on a
                production floor, not on a profile page. Scraped databases
                simply don't have them.
              </p>
            </div>
            <div className="rounded-2xl border border-white/10 bg-white/5 p-6">
              <h3 className="font-semibold mb-2 text-purple-300">
                Switchboards, not people
              </h3>
              <p className="text-gray-400 text-sm leading-relaxed">
                Most pharma listings give you a plant board line and a generic
                inbox. Neither reaches the person who qualifies your product or
                signs the order.
              </p>
            </div>
            <div className="rounded-2xl border border-white/10 bg-white/5 p-6">
              ...
              <p className="text-gray-400 text-sm leading-relaxed">
                India's pharma clusters run from Hyderabad and Ahmedabad to
                Baddi, Sikkim, and Vizag. Global tools thin out fast outside the
                metros — that's where we research by hand.
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="rounded-2xl border border-white/10 bg-gradient-to-b from-white/5 to-white/[0.02] p-6 lg:p-8">
              ...
              <ul className="text-gray-400 text-sm leading-relaxed space-y-2">
                <li>→ R&amp;D and formulation development heads</li>
                <li>→ Quality heads, QA and QC managers</li>
                <li>→ Regulatory affairs heads</li>
                <li>→ Plant heads and production heads</li>
            ...
            <div className="rounded-2xl border border-white/10 bg-gradient-to-b from-white/5 to-white/[0.02] p-6 lg:p-8">
              ...
              <ul className="text-gray-400 text-sm leading-relaxed space-y-2">
                <li>→ Formulations and generics</li>
                <li>→ APIs and intermediates</li>
                <li>→ Contract manufacturing (CDMO/CMO)</li>
                <li>→ Nutraceuticals and supplements</li>
                <li>→ Ayurvedic and herbal manufacturing</li>
                <li>→ Packaging and pharma machinery suppliers</li>
              </ul>
            </div>
          </div>
        </div>
      ...
      <section className="relative z-10 border-t border-white/10">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-14">
          ...
          <p className="text-gray-400 max-w-3xl mb-8 leading-relaxed">
            ...
            targeted list of R&amp;D heads or sustained delivery across the
            whole pharma vertical, the process is the same.
          </p>
        ...
        <div className="relative rounded-2xl border border-white/10 bg-gradient-to-br from-[#0b0b12] to-[#0a0a10] p-6 md:p-8 lg:p-10 flex flex-col md:flex-row items-start md:items-center justify-between gap-6 overflow-hidden">
          ...
          <div className="relative z-10 max-w-xl">
            <h2 className="text-2xl md:text-4xl font-light text-gray-200 leading-tight">
              Need pharma R&amp;D and quality heads in your pipeline?
            </h2>
